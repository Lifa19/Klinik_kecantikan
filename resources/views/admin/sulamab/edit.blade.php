  ...
  <section class="section">
    <div class="section-header">
      <div class="section-header-back">
        <a href="{{ route('sulamab.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
      </div>
      <h1>Silam Alis & Bibir</h1>
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
        {{-- <div class="breadcrumb-item"><a href="#">Posts</a></div> --}}
        {{-- <div class="breadcrumb-item"><a href="#">Silam Alis & Bibir</a></div> --}}
        <div class="breadcrumb-item">Edit Silam Alis & Bibir</div>
      </div>
    </div>
    <div class="section-body">
      <h2 class="section-title">Silam Alis & Bibir</h2>
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Edit Silam Alis & Bibir</h4>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('sulamab.update', [$treatment->id]) }}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf

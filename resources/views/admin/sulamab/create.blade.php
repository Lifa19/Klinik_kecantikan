...
<div class="main-content">
  <section class="section">
    <div class="section-header">
      ...
      <h1>Sulam Alis & Bibir</h1>
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
        {{-- <div class="breadcrumb-item"><a href="#">Posts</a></div> --}}
        <div class="breadcrumb-item"><a href="#">Sulam Alis & Bibir</a></div>
        <div class="breadcrumb-item">Tambah Sulam Alis & Bibir</div>
      </div>
    </div>
    <div class="section-body">
      <h2 class="section-title">Sulam Alis & Bibir</h2>
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Tambah Sulam Alis & Bibir</h4>
            </div>
            <div class="card-body">
              <form action="{{ route('sulamab.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

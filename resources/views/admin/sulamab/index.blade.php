        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Sulam Alis & Bibir</div>
              </div>
          </div>
          @if (session('success'))
              <div class="col-sm-12">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4>Sulam Alis & Bibir</h4>
                  <a href="{{ route('sulamab.create') }}"> <button class="btn btn-primary" >Tambah</button></a>
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <table class="table table-striped" id="sortable-table">
                      ...
                      <tbody>
                        @foreach ($treatments->where('name', 'Sulam Alis & Bibir') as $treatment)
                          ...
                          <tr>
                            ...
                            <td>{{ $item->quota }}</td>
                            <td>
                              <a href="{{ route('sulamab.edit', $item->id) }}" class="btn btn-secondary">
                                <i class="fa-solid fa-pen"></i>
                            </a>

                            <form action="{{ route('sulamab.destroy', $item->id) }}" method="POST">
                                <td>
                                <a href="{{ route('sulamab.edit', $item->id) }}" class="btn btn-secondary">
                                    <i class="fa-solid fa-pen"></i>
                                </a>

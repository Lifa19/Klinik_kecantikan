  ...
  <section class="section">
    <div class="section-header">
      <div class="section-header-back">
        <a href="{{ route('tubuh.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
      </div>
      <h1>Treatment Tubuh</h1>
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
        {{-- <div class="breadcrumb-item"><a href="#">Posts</a></div> --}}
        {{-- <div class="breadcrumb-item"><a href="#">Treatment Tubuh</a></div> --}}
        <div class="breadcrumb-item">Edit Treatment Tubuh</div>
      </div>
    </div>
    <div class="section-body">
      <h2 class="section-title">Treatment Tubuh</h2>
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Edit Treatment Tubuh</h4>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('tubuh.update', [$treatment->id]) }}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf

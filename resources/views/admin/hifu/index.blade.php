        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Hifu Treatment</div>
              </div>
          </div>
          @if (session('success'))
              <div class="col-sm-12">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4>Hifu Treatment</h4>
                  <a href="{{ route('hifu.create') }}"> <button class="btn btn-primary" >Tambah</button></a>
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <table class="table table-striped" id="sortable-table">
                      ...
                      <tbody>
                        @foreach ($treatments->where('name', 'Hifu Treatment') as $treatment)
                          ...
                          <tr>
                            ...
                            <td>{{ $item->quota }}</td>
                            <td>
                              <a href="{{ route('hifu.edit', $item->id) }}" class="btn btn-secondary">Edit</a>

                              <form action="{{ route('hifu.destroy', $item->id) }}" method="POST">

            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4>Private Class</h4>
                  <a href="{{ route('workshop.create') }}"> <button class="btn btn-primary" >Tambah</button></a>
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <table class="table table-striped" id="sortable-table">
                      ...
                      <tbody>
                        @foreach ($academies->where('name', 'Seminar') as $academy)
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{ route('workshop.edit', $item->id) }}" class="btn btn-secondary">
                                <i class="fa-solid fa-pen"></i>
                            </a>

                              <form action="{{ route('workshop.destroy', $item->id) }}" method="POST">

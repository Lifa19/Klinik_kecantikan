  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item"><a href="{{ route('academy.index') }}">Academy</a></div>
        <div class="breadcrumb-item">Tambah Academy</div>
      </div>
    </div>
          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group row mb-4">
                ...
                <div class="col-sm-12 col-md-7">
                  <input type="number" class="form-control @error('discount') is-invalid @enderror" id="inputDiscount" name="discount" placeholder="Diskon">
                  @error('discount')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>

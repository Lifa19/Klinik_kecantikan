        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Treatment</div>
              </div>
          </div>
          @if (session('success'))
              <div class="col-sm-12">
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <table class="table table-striped" id="sortable-table">
                      ...
                      <tbody>
                    @foreach ($products->where('name', 'Treatment') as $product)
                        ...
                        <tr>
                          ...
                          {{-- <td> --}}
                            ...
                            <td>
                                <a href="{{ route('treatment.edit', $item->id) }}" class="btn btn-secondary">
                                    <i class="fa-solid fa-pen"></i>
                                </a>
                                <form action="{{ route('treatment.destroy', $item->id) }}" method="POST" class="d-inline">

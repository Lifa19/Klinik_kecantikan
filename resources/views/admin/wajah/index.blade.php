        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Treatment Wajah</div>
              </div>
          </div>
          @if (session('success'))
              <div class="col-sm-12">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4>Treatment Wajah</h4>
                  <a href="{{ route('wajah.create') }}"> <button class="btn btn-primary" >Tambah</button></a>
                        ...
                        @foreach ($treatments->where('name', 'Treatment Wajah') as $treatment)
                          ...
                          <tr>
                            ...
                            <form action="{{ route('wajah.destroy', $item->id) }}" method="POST">
                                <td>
                                <a href="{{ route('wajah.edit', $item->id) }}" class="btn btn-secondary">

  ...
  <section class="section">
    <div class="section-header">
      <div class="section-header-back">
        <a href="{{ route('wajah.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
      </div>
      <h1>Treatment Wajah</h1>
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
        {{-- <div class="breadcrumb-item"><a href="#">Posts</a></div> --}}
        <div class="breadcrumb-item"><a href="{{ route('wajah.index') }}">Treatment Wajah</a></div>
        <div class="breadcrumb-item">Tambah Treatment Wajah</div>
      </div>
    </div>
    <div class="section-body">
      <h2 class="section-title">Treatment Wajah</h2>
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Tambah Treatment Wajah</h4>
            </div>
            <div class="card-body">
              <form action="{{ route('wajah.store') }}" method="POST" enctype="multipart/form-data">
                @csrf

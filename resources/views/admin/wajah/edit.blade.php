  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        {{-- <div class="breadcrumb-item"><a href="#">Treatment Wajah</a></div> --}}
        <div class="breadcrumb-item">Edit Treatment Wajah</div>
      </div>
    </div>
      ...
      <div class="row">
        <div class="col-12">
          <div class="card">
            ...
            <div class="card-body">
                <form method="POST" action="{{ route('wajah.update', [$treatment->id]) }}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf

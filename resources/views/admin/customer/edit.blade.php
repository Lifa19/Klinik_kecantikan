        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumd-item"><a href="#"> Pelanggan</a></div>
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                <div class="form-group">
                  ...
                  <input type="text"class="form-control @error('name') is-invalid @enderror" id="inputNama4" name="name" value="{{$customer->name}}" placeholder="Nama">
                ...
                <div class="form-group">
                  <div class="form-group">
                    ...
                    <input type="text"class="form-control @error('address') is-invalid @enderror" id="inputAddress" name="address" value="{{$customer->address}}" placeholder="Alamat">
                  ...
                  <div class="form-group">
                    <div class="form-group">
                      ...
                      <input type="text"class="form-control @error('phone') is-invalid @enderror" id="inputPhone" name="phone" value="{{$customer->phone}}" placeholder="Telepon">
                    ...
                    <div class="form-group">
                      <div class="form-group">
                        ...
                        <input type="text"class="form-control @error('datOfBirth') is-invalid @enderror" id="inputDateOfBirth" name="dateOfBirth" value="{{$customer->dateOfBirth}}" placeholder="Tanggal Lahir">

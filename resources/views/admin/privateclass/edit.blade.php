  ...
  <section class="section">
    <div class="section-header">
      ...
      <div class="section-header-breadcrumb">
        ...
        <div class="breadcrumb-item">Edit Private Class</div>
      </div>
    </div>
        ...
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Edit Private Class</h4>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('privateclass.update', [$academy->id]) }}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf

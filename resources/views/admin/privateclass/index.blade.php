        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
                ...
                <div class="breadcrumb-item">Private Class</div>
              </div>
          </div>
          @if (session('success'))
              <div class="col-sm-12">
            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  <h4>Private Class</h4>
                  <a href="{{ route('privateclass.create') }}"> <button class="btn btn-primary" >Tambah</button></a>
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <table class="table table-striped" id="sortable-table">
                      ...
                      <tbody>
                        @foreach ($academies->where('name', 'Private Class') as $academy)
                          ...
                          <tr>
                            ...
                            <td>
                              <a href="{{ route('privateclass.edit', $item->id) }}" class="btn btn-secondary">
                                <i class="fa-solid fa-pen"></i>
                            </a>

                            <form action="{{ route('privateclass.destroy', $item->id) }}" method="POST">
                                <td>
                                <a href="{{ route('privateclass.edit', $item->id) }}" class="btn btn-secondary">
                                    <i class="fa-solid fa-pen"></i>
                                </a>

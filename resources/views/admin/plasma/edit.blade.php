  ...
  <section class="section">
    <div class="section-header">
      <div class="section-header-back">
        <a href="{{ route('plasma.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
      </div>
      <h1>Plasma Fibroblasma Therapy</h1>
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
        {{-- <div class="breadcrumb-item"><a href="#">Posts</a></div> --}}
        {{-- <div class="breadcrumb-item"><a href="#">Plasma Fibroblasma Therapy</a></div> --}}
        <div class="breadcrumb-item">Edit Plasma Fibroblasma Therapy</div>
      </div>
    </div>
    <div class="section-body">
      <h2 class="section-title">Plasma Fibroblasma Therapy</h2>
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Edit Plasma Fibroblasma Therapy</h4>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('plasma.update', [$treatment->id]) }}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf
        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumd-item"><a href="#">Plasma Fibroblasma Therapy</a></div>
          ...
          <div class="card">
            <div class="card-header">
              <h4>Plasma Fibroblasma Therapy</h4>
            </div>
            <div class="card-body">
              <form action="{{ route('plasma.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label for="inputQuota">Kuota</label>
                  <input type="number" class="form-control @error('quota') is-invalid @enderror" id="inputQuota" name="quota" placeholder="Kuota">
                      @error('quota')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>

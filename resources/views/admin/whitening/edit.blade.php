  ...
  <section class="section">
    <div class="section-header">
      <div class="section-header-back">
        <a href="{{ route('whitening.index') }}" class="btn btn-icon"><i class="fas fa-arrow-left"></i></a>
      </div>
      <h1>Whitening</h1>
      <div class="section-header-breadcrumb">
        <div class="breadcrumb-item active"><a href="#">Dashboard</a></div>
        {{-- <div class="breadcrumb-item"><a href="#">Posts</a></div> --}}
        {{-- <div class="breadcrumb-item"><a href="#">Whitening</a></div> --}}
        <div class="breadcrumb-item">Edit Whitening</div>
      </div>
    </div>
    <div class="section-body">
      <h2 class="section-title">Whitening</h2>
      <div class="row">
        <div class="col-12">
          <div class="card">
            <div class="card-header">
              <h4>Edit Whitening</h4>
            </div>
            <div class="card-body">
                <form method="POST" action="{{ route('whitening.update', [$treatment->id]) }}" enctype="multipart/form-data">
                    @method('PUT')
                    @csrf

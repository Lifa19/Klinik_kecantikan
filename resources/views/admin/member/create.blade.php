          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="form-group">
                ...
                <div class="form-group">
                  <label for="inputRegisterDate">Tanggal Registrasi</label>
                  <input type="date" class="form-control @error('register_date') is-invalid @enderror" id="inputRegisterDate" name="register_date" placeholder="Tanggal Registrasi">
                </div>

            ...
            <div class="col-12">
              <div class="card">
                <div class="card-header">
                  ...
                  <a href="{{ route('plasma.create') }}"> <button class="btn btn-primary" >Tambah</button></a>
                ...
                <div class="card-body p-0">
                  <div class="table-responsive">
                    <table class="table table-striped" id="sortable-table">
                      ...
                      <tbody>
                        @foreach ($treatments->where('name', 'Plasma Fibroblasma Therapy') as $treatment)
                          ...
                          <tr>
                            ...
                            <td>{{ $item->quota }}</td>
                            <td>
                              <a href="{{ route('plasma.edit', $item->id) }}" class="btn btn-secondary">Edit</a>

                              <form action="{{ route('plasma.destroy', $item->id) }}" method="POST">
